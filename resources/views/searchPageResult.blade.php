...
<div class="container" style="margin-top: 20px;">
    <h2 class="mid" style="margin-top: 10px">
        Search Result for '{{$searchVar}}'
    </h2>
<br>
@if(!Auth::check() || Auth::user()->role==0)
  <div class="row">
  @foreach($flowerQuery as $flower)      
        <div class="col-lg-3">
          ...
          <a href="{{route('productDetailView',['id'=>$flower->id])}}" class="text-decoration-none">
            <div class="card" id="kartu">
              <img src="{{asset('/'.$flower->flowerImage)}}" id="gambar"  alt="...">
                ...
                <div>
                <a href="{{route('updateView',['id'=>$flower->id])}}" type="button" id="button1" class="btn btn-outline-success">Update Flower</a>
