          ...
          <a href="<?php echo e(route('categoryView',['id'=>$flower->id])); ?>" class="text-decoration-none">
            <div class="card" id="kartu">
              <img src="<?php echo e(asset('/'.$flower->categoryImage)); ?>" id="gambar"  alt="...">
                ...
                <div>
                    <a href="<?php echo e(route('updateCategoryView',['id'=>$flower->id])); ?>" type="button" id="button1" class="btn btn-outline-success">Update Category</a>
                    <form style="display:inline"action="<?php echo e(route('submitDeleteCategoryData',['id'=>$flower->id])); ?>" method="post">
...
<?php echo $__env->make('navbarGuest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\Sem 5\Web Programming\Projek\learning\resources\views/manageCategory.blade.php ENDPATH**/ ?>